...
const (
	...
	querySelectIdService        = "SELECT id, category, code, name, price, program_id, sid, renewal_day, trial_day, url_telco, url_portal, url_notif_sub, url_notif_unsub, url_notif_renewal, url_postback, url_postback_billable, url_postback_sam_mo, url_postback_sam_dn, url_postback_ylc_mo, url_postback_ylc_mt, url_postback_fs_mo, url_postback_fs_dn, url_postback_plw_mo, url_postback_plw_dn, url_postback_star_mo, url_postback_star_dn, url_postback_mxo_mo, url_postback_mxo_dn, url_postback_stars_mo, url_postback_unt_mo, url_postback_unt_dn, url_wakicamp_fp FROM services WHERE id = $1 LIMIT 1"
	querySelectCodeService      = "SELECT id, category, code, name, price, program_id, sid, renewal_day, trial_day, url_telco, url_portal, url_notif_sub, url_notif_unsub, url_notif_renewal, url_postback, url_postback_billable, url_postback_sam_mo, url_postback_sam_dn, url_postback_ylc_mo, url_postback_ylc_mt, url_postback_fs_mo, url_postback_fs_dn, url_postback_plw_mo, url_postback_plw_dn, url_postback_star_mo, url_postback_star_dn, url_postback_mxo_mo, url_postback_mxo_dn, url_postback_stars_mo, url_postback_unt_mo, url_postback_unt_dn, url_wakicamp_fp FROM services WHERE code = $1 LIMIT 1"
)
